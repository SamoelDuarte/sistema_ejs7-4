...
<input type="hidden" name="id" id="id_device" value="<?= $device ?>">
<input type="hidden" name="session" id="session_device" value="<?= $session ?>">
<?php
echo form_close();
?>
...
<script type='text/javascript'>
	...
	function verificarCondicao() {
		...
		$.ajax({
			...
			data: {
				sessionId: session
			}, // Aqui passamos o parâmetro na requisição GET
			success: function(response) {
